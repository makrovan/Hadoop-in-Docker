...
kadmin.local -q 'addprinc -randkey knox/hadoop-knox.docker.net@DOCKER.NET'
kadmin.local -q 'addprinc -randkey HTTP/hadoop-knox.docker.net@DOCKER.NET'
kadmin.local -q 'ktadd -norandkey -k knox.service.keytab HTTP/hadoop-knox.docker.net@DOCKER.NET knox/hadoop-knox.docker.net@DOCKER.NET'
chmod +r ./*
