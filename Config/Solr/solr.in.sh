...
SOLR_SSL_KEY_STORE=/tmp/ssl/keystore.jks
SOLR_SSL_KEY_STORE_PASSWORD=hadoop
SOLR_SSL_TRUST_STORE=/etc/CA/mycacert.jks
SOLR_SSL_TRUST_STORE_PASSWORD=hadoop
...
SOLR_AUTHENTICATION_OPTS=" -Djava.security.auth.login.config=$SOLR_JAAS_FILE \
